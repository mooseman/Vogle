        ...
        Matrix     tb, ub;
{
        if(!vdevice.initialised)
                verror("patchbasis: vogle not initialised");
...
{
        if (!vdevice.initialised)
                verror("patchprecision: vogle not initialised");
        ...
        int     nt, nu;
{
        ...
        if (!vdevice.initialised)
                verror("patchcurves: vogle not initialised");
        ...
        Matrix  geomx, geomy, geomz, geomw;
{
	...
	Token	*tok;
        ...
        if (!vdevice.initialised)
                verror("patch: vogle not initialised");
