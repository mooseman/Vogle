...
HPGL_A4_init()
{
	...
	return(HPGL_common_init(-3660, 3660, -3660, 3660));
}
...
HPGL_A3_init()
{
	...
	return(HPGL_common_init(-5280, 5280, -5280, 5280));
}
...
HPGL_A2_init()
{
	...
	return(HPGL_common_init(-6720, 6720, -6720, 6720));
}
...
HPGL_A1_init()
{
	...
	return(HPGL_common_init(-10680, 10680, -10680, 10680));
}
